...
/**
 * Jersey REST client generated for REST resource:GpuClockFacadeREST
 * [com.mycompany.ser.gpuclock]<br>
 * USAGE:
 * <pre>
 ...
 * @author Vit
 */
public class gpuClockNewJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/ser-1/webresources";

    public gpuClockNewJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("com.mycompany.ser.gpuclock");
    }
