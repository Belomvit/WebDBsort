...
/**
 * Jersey REST client generated for REST resource:MemoryFacadeREST
 * [com.mycompany.ser.memory]<br>
 * USAGE:
 * <pre>
 *        memNewJerseyClient client = new memNewJerseyClient();
 ...
 * @author Vit
 */
public class memNewJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/ser-1/webresources";

    public memNewJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("com.mycompany.ser.memory");
    }
