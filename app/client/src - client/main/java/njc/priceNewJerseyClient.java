...
/**
 * Jersey REST client generated for REST resource:PriceFacadeREST
 * [com.mycompany.ser.price]<br>
 * USAGE:
 * <pre>
 *        priceNewJerseyClient client = new priceNewJerseyClient();
 ...
 * @author Vit
 */
public class priceNewJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/ser-1/webresources";

    public priceNewJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("com.mycompany.ser.price");
    }
