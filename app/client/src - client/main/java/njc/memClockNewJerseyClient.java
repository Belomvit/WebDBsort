...
/**
 * Jersey REST client generated for REST resource:MemoryClockFacadeREST
 * [com.mycompany.ser.memoryclock]<br>
 * USAGE:
 * <pre>
 *        memClockNewJerseyClient client = new memClockNewJerseyClient();
 ...
 * @author Vit
 */
public class memClockNewJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/ser-1/webresources";

    public memClockNewJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("com.mycompany.ser.memoryclock");
    }
